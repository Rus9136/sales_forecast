...
- **Scheduler**: APScheduler (13 задач: nomenclature, employees, sales, receipts, waiter sales, retrain, SKU retrain, recipes, menu clustering, elasticity estimation, metrics, pricing analytics, gap checks ×3)
...
- **05:00 Sun** — Weekly price elasticity estimation (B2, lookback 730д → sku_elasticity)
